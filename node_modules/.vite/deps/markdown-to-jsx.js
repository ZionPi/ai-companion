...
var $e = be(2);
function we(e2, n2) {
  const t2 = 1 === n2, r2 = t2 ? ve : $e, i2 = t2 ? ke : xe, l2 = t2 ? me : ge;
...
function Re(e2, n2, t2) {
  t2.inline = true;
  const r2 = Le(e2[1], n2, t2), i2 = e2[2].replace(Z, "").split("|").map(Te), l2 = function(e3, n3, t3) {
...
function Ve(t2 = "", r2 = {}) {
  ...
  function d2(e2, t3, ...l2) {
    const o2 = qe(r2.overrides, `${e2}.props`, {});
    return i2(function(e3, n2) {
      const t4 = qe(n2, e3);
      return t4 ? "function" == typeof t4 || "object" == typeof t4 && "render" in t4 ? t4 : qe(n2, `${e3}.component`, e3) : e3;
    }(e2, r2.overrides), n({}, t3, o2, { className: Ze(null == t3 ? void 0 : t3.className, o2.className) || void 0 }), ...l2);
  }
  function Z2(n2) {
    n2 = n2.replace(w, "");
    let t3 = false;
    r2.forceInline ? t3 = true : r2.forceBlock || (t3 = false === F.test(n2));
    const i3 = oe2(J2(t3 ? n2 : `${n2.trimEnd().replace(ie, "")}
    ...
    return t3 ? t3.reduce(function(n3, t4, r3) {
      ...
      if (-1 !== i3) {
        const o2 = function(e2) {
          ...
          }, {}) : "href" === e2 || "src" === e2 ? Ne(n4) : (n4.match(M) && (n4 = n4.slice(1, n4.length - 1)), "true" === n4 || "false" !== n4 && n4);
        }(o2, c2);
        "string" == typeof s2 && (O.test(s2) || z.test(s2)) && (n3[a2] = e.cloneElement(Z2(s2.trim()), { key: r3 }));
      } else
        "style" !== t4 && (n3[l[t4] || t4] = true);
      return n3;
    }, {}) : null;
  }
  const V2 = [], X2 = {}, Q2 = { 0: { match: Ue(u), order: 1, parse: (e2, n2, t3) => ({ children: n2(e2[0].replace(p, ""), t3) }), render: (e2, n2, t3) => d2("blockquote", { key: t3.key }, n2(e2.children, t3)) }, 1: { match: je(f), order: 1, parse: We, render: (e2, n2, t3) => d2("br", { key: t3.key }) }, 2: { match: Ue(h), order: 1, parse: We, render: (e2, n2, t3) => d2("hr", { key: t3.key }) }, 3: { match: Ue(g), order: 0, parse: (e2) => ({ lang: void 0, text: e2[0].replace(/^ {4}/gm, "").replace(/\n+$/, "") }), render: (e2, t3, r3) => d2("pre", { key: r3.key }, d2("code", n({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text)) }, 4: { match: Ue(m), order: 0, parse: (e2) => ({ attrs: q2(e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: "3" }) }, 5: { match: Ie(y), order: 3, parse: (e2) => ({ text: e2[2] }), render: (e2, n2, t3) => d2("code", { key: t3.key }, e2.text) }, 6: { match: Ue(b), order: 0, parse: (e2) => (V2.push({ footnote: e2[2], identifier: e2[1] }), {}), render: Ge }, 7: { match: Me(v), order: 1, parse: (e2) => ({ target: `#${r2.slugify(e2[1])}`, text: e2[1] }), render: (e2, n2, t3) => d2("a", { key: t3.key, href: Ne(e2.target) }, d2("sup", { key: t3.key }, e2.text)) }, 8: { match: Me(E), order: 1, parse: (e2) => ({ completed: "x" === e2[1].toLowerCase() }), render: (e2, n2, t3) => d2("input", { checked: e2.completed, key: t3.key, readOnly: true, type: "checkbox" }) }, 9: { match: Ue(r2.enforceAtxHeadings ? C : S), order: 1, parse: (e2, n2, t3) => ({ children: De(n2, e2[2], t3), id: r2.slugify(e2[2]), level: e2[1].length }), render: (e2, n2, t3) => d2(`h${e2.level}`, { id: e2.id, key: t3.key }, n2(e2.children, t3)) }, 10: { match: Ue(A), order: 0, parse: (e2, n2, t3) => ({ children: De(n2, e2[1], t3), level: "=" === e2[2] ? 1 : 2, type: "9" }) }, 11: { match: je(O), order: 1, parse(e2, n2, t3) {
    const [, r3] = e2[3].match(le), i3 = new RegExp(`^${r3}`, "gm"), l2 = e2[3].replace(i3, ""), o2 = (a2 = l2, Ae.some((e3) => e3.test(a2)) ? _e : De);
    var a2;
    const s2 = e2[1].toLowerCase(), d3 = -1 !== c.indexOf(s2), u2 = { attrs: q2(e2[2]), noInnerParse: d3, tag: (d3 ? s2 : e2[1]).trim() };
    ...
    return { type: "26" };
  }, render: () => " | " }, 27: { match: je(re), order: 4, parse: (e2) => ({ text: e2[0].replace(T, (e3, n2) => r2.namedCodesToUnicode[n2] ? r2.namedCodesToUnicode[n2] : e3) }), render: (e2) => e2.text }, 28: { match: Ie(K), order: 2, parse: (e2, n2, t3) => ({ children: n2(e2[2], t3) }), render: (e2, n2, t3) => d2("strong", { key: t3.key }, n2(e2.children, t3)) }, 29: { match: Ie(Y), order: 3, parse: (e2, n2, t3) => ({ children: n2(e2[2], t3) }), render: (e2, n2, t3) => d2("em", { key: t3.key }, n2(e2.children, t3)) }, 30: { match: Ie(te), order: 1, parse: (e2) => ({ text: e2[1], type: "27" }) }, 31: { match: Ie(ee), order: 3, parse: Fe, render: (e2, n2, t3) => d2("mark", { key: t3.key }, n2(e2.children, t3)) }, 32: { match: Ie(ne), order: 3, parse: Fe, render: (e2, n2, t3) => d2("del", { key: t3.key }, n2(e2.children, t3)) } };
...
var index_modern_default = (n2) => {
  ...
  return e.cloneElement(Ve(r2, i2), l2);
};
export {
  r as RuleType,
  Ve as compiler,
