...
var require_dist = __commonJS({
  "node_modules/svg-path-bbox/dist/index.js"(exports) {
    "use strict";
    ...
    exports.default = svgPathBbox2;
  }
});

// node_modules/svg-path-bbox/dist/wrapper.js
var require_wrapper = __commonJS({
  "node_modules/svg-path-bbox/dist/wrapper.js"(exports, module) {
...
function randomInt(minInclusive, max, inclusiveMax = false) {
  if (inclusiveMax) {
    max += 1;
  }
...
var generate = (overrides, options) => {
  ...
  const face = {
    ...
    body: {
      ...
      color: skinColor,
      size: roundTwoDecimals(Math.random() * 0.1 + (gender === "female" ? 0.8 : 0.95))
    },
    jersey: {
...
var import_svg_path_bbox = __toESM(require_wrapper(), 1);
  ...
  constructor(tag, xml) {
    ...
    if ((_a = this.xml) == null ? void 0 : _a.startsWith("<g>")) {
      ...
      while (true) {
        ...
        const bbox = (0, import_svg_path_bbox.default)(path);
...
// node_modules/facesjs/build/esmodules/Face.js
var import_react = __toESM(require_react(), 1);

// node_modules/facesjs/build/esmodules/utils.js
var deepCopy = (object) => {
...
var Face = (0, import_react.forwardRef)(({
  className,
  face,
  ignoreDisplayErrors,
  lazy,
  ...
  (0, import_react.useLayoutEffect)(() => {
    if (((intersectionObserverEntry == null ? void 0 : intersectionObserverEntry.isIntersecting) || !lazy) && faceRef.current) {
      try {
        if (overrides) {
