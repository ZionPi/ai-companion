                ...
                <div className="px-2">
                    <div className="py-4">
                        <a
                            ...
                            onClick={() => { handleHighlight('conversation'); onLinkClick('conversation'); }}
                        >
                            <svg className="w-5 h-5" dataSlot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <ul className="space-y-1 border-t border-gray-100 pt-4">
                        ...
                        <li>
                            <a
                                ...
                                onClick={() => { handleHighlight('history'); onLinkClick('history'); }}
                            >
                                <svg className="w-5 h-5" dataSlot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <li>
                            <a
                                ...
                                onClick={() => { handleHighlight('randomize'); onLinkClick('randomize'); }}
                            >
                                <svg className="w-5 h-5" dataSlot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <li className="hidden">
                            <a
                                ...
                                onClick={() => { handleHighlight('account'); onLinkClick('account'); }}
                            >
                                <svg className="w-5 h-5" dataSlot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <li>
                            ...
                            <a
                                ...
                                onClick={() => { handleHighlight('setting'); onLinkClick('setting'); }}
                            >
        ...
        <div className="sticky inset-x-0 bottom-0 border-t border-gray-100 bg-white p-2">
            <form action="#">
                <button
                    ...
                    onClick={() => { handleHighlight('logout'); onLinkClick('logout'); }}
                >
                    <svg className="w-5 h-5" dataSlot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
