...
function ConversationComponent() {
    ...
    function renderContent() {
        ...
        const QuoteBanner = ({ configData, colorsData, onDismiss }) => {
        return showQuote&&(
            <div className={`flex items-center justify-between gap-4 bg-[${colorsData.bg_color}] px-4 py-3 text-white`}>
            <h1 className={`text-1xl font-medium text-[${colorsData.fg_color}]`}>
                {configData.quote}
            </h1>
            ...
            <button
                ...
                onClick={onDismiss} // Call the provided onDismiss function
            >
    ...
    return (
        <div className='flex flex-col mt-2 w-[360px] md:w-[800px] lg:w-[1340px] lg-relative  max-sm:mx-2 mx-5 relative' >
            ...
            <QuoteBanner configData={configData} colorsData={colorsData} onDismiss={onCloseQuote} ></QuoteBanner>
            ...
            <a className='flex justify-start rounded hover:text-gray-700' onClick={() => toggleMode()} >
                <span
                    className={`mt-1 w-[68px] inline-flex items-center justify-center rounded-lg  bg-cyan-100 hover:bg-cyan-200 px-2.5 py-0.5 text-[${colorsData.bg_color}]`}
                >
                    ...
                    <p className={`whitespace-nowrap text-sm text-[${colorsData.bg_color}]`}>{modeTitle}</p>
